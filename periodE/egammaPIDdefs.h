...
namespace egammaPID { 
 ...
 /*! \enum Bitdefinitons for the egamma identification tools */
  ...
  /** @brief Tight electron selection (NB: changed since 15.7.0)*/
  ...
  const unsigned int ElectronTightRobust = 
    ...
    CONVMATCH_ELECTRON | 
    TRT_ELECTRON ;
  /** @brief Tight robust without conversion requirement */
  const unsigned int ElectronTightRobust_NoConvCut = 
    CALO_ELECTRON | 
    TRACKING_ELECTRON | 
    0x1 << TrackMatchEta_Electron | 
    0x1 << TrackMatchEoverP_Electron | 
  ...
  const unsigned int ElectronTightIso = 
    ElectronTight | 
    ISOLATION_ELECTRON;
  /** @brief Tight Robust electron selection with isolation requirement */
  const unsigned int ElectronTightRobustIso = 
    ElectronTightRobust | 
    ISOLATION_ELECTRON;
  /** @brief Tight Robust electron selection with isolation requirement */
  const unsigned int ElectronTightRobustIso_NoConvCut = 
    ElectronTightRobust_NoConvCut | 
    ISOLATION_ELECTRON;
